...
@Component({
  selector: 'app-payroll-finance',
  templateUrl: './payroll-finance.component.html',
  styleUrls: ['./payroll-finance.component.css']
})

export class PayrollFinanceComponent implements OnInit {
