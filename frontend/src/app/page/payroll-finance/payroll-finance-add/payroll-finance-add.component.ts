...
@Component({
  selector: 'app-payroll-finance-add',
  templateUrl: './payroll-finance-add.component.html',
  styleUrls: ['./payroll-finance-add.component.css']
})
export class PayrollFinanceAddComponent implements OnInit{
